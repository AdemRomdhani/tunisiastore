    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      @if (loading()) {
        ...
        <div class="text-center py-12">
          <p class="text-gray-500 mb-4">Votre liste est vide</p>
          <a routerLink="/products" class="text-primary-600 hover:underline">Continuer vos achats</a>
        </div>
      } @else {
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div class="p-4">
                ...
                <div class="mt-3 flex gap-2">
                  ...
                  <button (click)="removeFromWishlist(product._id)" class="p-2 text-red-500 hover:bg-red-50 rounded-lg" title="Supprimer">
